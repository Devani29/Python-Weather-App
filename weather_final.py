...
weather_bg = Image.open("sky_bg.png")  # Reemplaza con la ruta de tu imagen
weather_bg = weather_bg.resize((900, 500))  # Ajustar al tamaño de la ventana
...
# # Agregar otros widgets encima
# tk.Label(root, text="Hola, mundo!", font=("Arial", 20), bg="white").pack(pady=20)
