...
def create_ui_elements(root):
    root.images = {}
    # Background
    weather_bg = Image.open("src/assets/images/bg_weather.jpg").resize((900, 500))
    ...
    for i, y in enumerate([20, 80, 140]):
        search_image=Image.open("src/assets/images/search.png").resize((290,60))
    ...
    # Search icon
    search_icon=Image.open("src/assets/images/search_icon.png").resize((40,40))
    ...
    # Box info
    box_info=Image.open("src/assets/images/box.png").resize((550,180))
    ...
    # Logo
    logo=Image.open("src/assets/images/logo.png")
